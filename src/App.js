...
import TrainerForgotPassword from './component/TrainerForgotPassword';
      ...
      <Router>
        ...
        <div className="container">
          <Switch>
            ...
            <Route path="/userforgot" component={UserForgotPassword}><UserForgotPassword /></Route>
            <Route path="/trainerforgot" component={TrainerForgotPassword}><TrainerForgotPassword /></Route>
            <Route path="/adminforgot" component={AdminForgotPassword}><AdminForgotPassword /></Route>
          </Switch>
        </div>
