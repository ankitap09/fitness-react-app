...
class TrainerForgotPassword extends Component {
  userData;
  constructor(props) {
    super(props);
    this.state = {
    ...
    this.TrainerForgotPassword = this.TrainerForgotPassword.bind(this);
  }
  ...
  TrainerForgotPassword(e) {
    e.preventDefault();

    if (this.validateForm()) {
      var apiBaseUrl =
        " http://localhost:8082/springfox/fitness/login/trainerforgot/" +
      ...
      axios
        ...
        .then(function (response) {
          ...
          window.location = "/TrainerLogin";
        })
        .catch(function (error) {
          window.open("/TrainerLogin");
        ...
        <div className="container">
          <div className="row">
            <div className="card col-md-6 offset-md-3 offset-md-3">
              <br />
              <br /> <h3 className="text-center">Forgot Password</h3>
                ...
                <fieldset>
                  <form>
                    ...
                    <button
                      ...
                      onClick={this.TrainerForgotPassword}
                    >
                      Save
                    </button>
                    <button
