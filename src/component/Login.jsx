  ...
  validateForm() {
    ...
    if (typeof this.state.password !== "undefined") {
      if (
        ...
        errors["password"] =
          "*Please enter atleast 6 digit password with atleast one uppercase, lowercase with atleast one digit and special character";
      }
    }
              ...
              >
                ...
                <div className="mt-4">
                  <div className="d-flex justify-content-center links">
                    ...
                    <Link href="/register" to="/register" className="linka">
                      Register
                    </Link>
                  </div>
