...
class UpdateAppointmentComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
               // appointment_id:this.props.match.params.appointment_id,
    ...
    componentDidMount(){
        AppointmentService.getAppointmentById(this.state.appointment_id).then((res)=>{
    ...
    updateAppointment = (e)=>{
       ...
       AppointmentService.updateAppointment(appointment,this.state.appointment_id).then((res) =>{
